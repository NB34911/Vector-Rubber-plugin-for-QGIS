...
class VectorRubber:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'VectorRubber_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Vector Rubber')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('VectorRubber', message)
    ...
    def unload(self):
        ...
        #print "** UNLOAD VectorRubber"

        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&Vector Rubber'),
                action)
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = VectorRubberDockWidget()
